angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.config(["entityApiProvider", function (entityApiProvider) {
		entityApiProvider.baseUrl = "/services/ts/bank-backend/gen/bank-backend/api/bankAccount/BankAccountsService.ts";
	}])
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', 'Extensions', function ($scope, $http, messageHub, entityApi, Extensions) {
		...
		$http.get("/services/ts/bank-backend/gen/bank-backend/api/Settings/BankAccountTypeService.ts").then(function (response) {
		...
		$http.get("/services/ts/bank-backend/gen/bank-backend/api/Settings/BankAccountStatusService.ts").then(function (response) {
