...
const validationModules = await Extensions.loadExtensionModules("bank-backend-users-Users", ["validate"]);
...
class UsersService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/bank-backend/gen/bank-backend/api/users/UsersService.ts/" + entity.Id);
