...
const validationModules = await Extensions.loadExtensionModules("bank-backend-bankAccount-BankAccounts", ["validate"]);
...
class BankAccountsService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/bank-backend/gen/bank-backend/api/bankAccount/BankAccountsService.ts/" + entity.Id);
