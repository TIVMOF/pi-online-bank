...
export class CardsRepository {
    ...
    private async triggerEvent(data: CardsEntityEvent | CardsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("bank-backend-cards-Cards", ["trigger"]);
        ...
        producer.topic("bank-backend-cards-Cards").send(JSON.stringify(data));
    }
}
