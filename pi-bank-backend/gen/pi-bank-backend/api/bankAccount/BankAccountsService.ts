...
const validationModules = await Extensions.loadExtensionModules("pi-bank-backend-bankAccount-BankAccounts", ["validate"]);
...
class BankAccountsService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/pi-bank-backend/gen/pi-bank-backend/api/bankAccount/BankAccountsService.ts/" + entity.Id);
