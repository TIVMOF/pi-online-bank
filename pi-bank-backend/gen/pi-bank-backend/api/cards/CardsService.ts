...
const validationModules = await Extensions.loadExtensionModules("pi-bank-backend-cards-Cards", ["validate"]);
...
class CardsService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/pi-bank-backend/gen/pi-bank-backend/api/cards/CardsService.ts/" + entity.Id);
