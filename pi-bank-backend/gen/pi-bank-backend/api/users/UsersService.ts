...
const validationModules = await Extensions.loadExtensionModules("pi-bank-backend-users-Users", ["validate"]);
...
class UsersService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/pi-bank-backend/gen/pi-bank-backend/api/users/UsersService.ts/" + entity.Id);
