...
export class UsersRepository {
    ...
    private async triggerEvent(data: UsersEntityEvent | UsersUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("pi-bank-backend-users-Users", ["trigger"]);
        ...
        producer.topic("pi-bank-backend-users-Users").send(JSON.stringify(data));
    }
}
