...
export class CardsRepository {
    ...
    private async triggerEvent(data: CardsEntityEvent | CardsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("pi-bank-backend-cards-Cards", ["trigger"]);
        ...
        producer.topic("pi-bank-backend-cards-Cards").send(JSON.stringify(data));
    }
}
