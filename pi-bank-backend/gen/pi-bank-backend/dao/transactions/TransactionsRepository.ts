...
export class TransactionsRepository {
    ...
    private async triggerEvent(data: TransactionsEntityEvent | TransactionsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("pi-bank-backend-transactions-Transactions", ["trigger"]);
        ...
        producer.topic("pi-bank-backend-transactions-Transactions").send(JSON.stringify(data));
    }
}
