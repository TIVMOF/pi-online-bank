...
export class TransactionsRepository {
    ...
    private async triggerEvent(data: TransactionsEntityEvent | TransactionsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("bank-backend-transactions-Transactions", ["trigger"]);
        ...
        producer.topic("bank-backend-transactions-Transactions").send(JSON.stringify(data));
    }
}
