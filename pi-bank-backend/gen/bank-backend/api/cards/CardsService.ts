...
const validationModules = await Extensions.loadExtensionModules("bank-backend-cards-Cards", ["validate"]);
...
class CardsService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/bank-backend/gen/bank-backend/api/cards/CardsService.ts/" + entity.Id);
