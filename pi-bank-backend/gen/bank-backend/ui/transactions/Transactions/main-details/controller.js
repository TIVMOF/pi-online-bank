angular.module('page', ["ideUI", "ideView", "entityApi"])
	.config(["messageHubProvider", function (messageHubProvider) {
		messageHubProvider.eventIdPrefix = 'bank-backend.transactions.Transactions';
	}])
	.config(["entityApiProvider", function (entityApiProvider) {
		entityApiProvider.baseUrl = "/services/ts/bank-backend/gen/bank-backend/api/transactions/TransactionsService.ts";
	}])
	.controller('PageController', ['$scope', 'Extensions', 'messageHub', 'entityApi', function ($scope, Extensions, messageHub, entityApi) {
		...
		//-----------------Custom Actions-------------------//
		Extensions.get('dialogWindow', 'bank-backend-custom-action').then(function (response) {
		...
		$scope.serviceReciever = "/services/ts/bank-backend/gen/bank-backend/api/bankAccount/BankAccountsService.ts";
		$scope.serviceSender = "/services/ts/bank-backend/gen/bank-backend/api/bankAccount/BankAccountsService.ts";
